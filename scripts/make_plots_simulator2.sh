...
tools/plot.py $DATA $PUB_1_1SIZE $ARGS -x 1 -y 1 $SCENARIOS --relative-divs --pairs='(1,0,"1ov - $f_{G2}=1.0$"),(3,2,"1ov - $f_{G2}=1.2$"),(5,4,"1ov - $f_{G2}=1.5$"),(7,6,"3ov - $f_{G2}=1.0$"),(9,8,"3ov - $f_{G2}=1.2$"),(11,10,"3ov - $f_{G2}=1.5$")' --linear --y_min=100 --y_max=300 -p served_u -n $SUFFIX --title-suffix='Elastic - $t_5=9\rightarrow 6\rightarrow 3$ vs No compression' --groups="('G2')" --no-pair-suffix

SUFFIX=_3_1g_random_1ov_3ov_t9_int6_int3
tools/plot.py $DATA $PUB_1_1SIZE $ARGS -x 1 -y 1 $SCENARIOS --relative-divs --pairs='(1,0,"1ov - $f_{G2}=1.0$"),(3,2,"1ov - $f_{G2}=1.2$"),(5,4,"1ov - $f_{G2}=1.5$"),(7,6,"3ov - $f_{G2}=1.0$"),(9,8,"3ov - $f_{G2}=1.2$"),(11,10,"3ov - $f_{G2}=1.5$")' --linear --y_min=100 --y_max=300 -p served -n $SUFFIX --title-suffix='Elastic - $t_5=9\rightarrow 6\rightarrow 3$ vs No compression' --groups="('G2')" --no-pair-suffix
